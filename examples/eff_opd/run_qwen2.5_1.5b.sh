...
# export PYTHONUNBUFFERED=1 && nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/eff_opd/run_qwen2.5_1.5b.sh >opd1_5b.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen2.5_1.5_brorl1e-6' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=10 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/qwen2.5_1.5_brorl1e-6 \
        trainer.test_freq=1 \
