...
Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/ProRL-1.5B-v2"}
# Standard OPD 

# export PYTHONUNBUFFERED=1 && nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/eff_opd/run_qwen2.5_1.5beff.sh > opd1_5beff.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen2.5_1.5_brorl_eff_lr1e-5' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=20 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/qwen2.5_1.5_brorl_eff_lr1e-5 \
        trainer.test_freq=1 \
