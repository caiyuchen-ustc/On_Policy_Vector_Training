...
# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/eff_opd/run_qwen3_14b_base.sh >opd14b.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        data.train_files=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/math/train_filtered_level6.parquet \
