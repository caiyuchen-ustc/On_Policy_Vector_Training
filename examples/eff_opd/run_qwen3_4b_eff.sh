...
# export PYTHONUNBUFFERED=1 && nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/eff_opd/run_qwen3_4b_eff.sh >opd4beff.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='eff_qwen3-4b' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=20 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/eff_qwen3-4b-opd \
        trainer.test_freq=1 \
