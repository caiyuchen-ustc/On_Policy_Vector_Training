...
python3 -m verl.trainer.main_ppo \
      ...
      trainer.experiment_name='qwen2.5_32b_base_teacher_qwen2.5_32b_rl1e-5' \
      trainer.n_gpus_per_node=8 \
      trainer.nnodes=4 \
      trainer.save_freq=10 \
      trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/qwen2.5_32b_base_teacher_qwen2.5_32b_rl1e-5 \
      trainer.test_freq=2 \
