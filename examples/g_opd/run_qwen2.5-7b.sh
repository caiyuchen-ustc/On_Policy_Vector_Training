...
MODEL_PATH=${MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen2.5-7B"}
Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Open-Reasoner-Zero-7B"}
# Standard OPD 

# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen2.5-7b.sh >opd7b.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen2.5_7b_teacher_Open-Reasoner-Zero-7B' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=2 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/qwen2.5_7b_base_teacher_Open-Reasoner-Zero-7B \
        trainer.test_freq=1 \
