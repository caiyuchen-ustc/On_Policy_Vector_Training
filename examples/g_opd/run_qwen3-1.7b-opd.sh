...
##nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen3-1.7b-opd.sh >opd1.7b.log 2>&1 &
MODEL_PATH=${MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen3-1.7B"}
Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen3-1.7B-MATH-RLVR-250"}
# Standard OPD 
# Standard OPD 
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen3_1.7b_teacher_qwen3_1.7b_rl_math_opd_deepmath' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=2 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/Qwen3-1.7B-Teacher-Qwen3-1.7B-RL-Math-OPD-DeepMath \
        trainer.test_freq=2 \
