...
MODEL_PATH=${MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen3-4B-Base"}
Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen3-4B-Base-RL"}
# Standard OPD 

# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen3-4b-base.sh >opd4bbase.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen3_4b_base_teacher_qwen3_4b_base_rl' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=2 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/qwen3_4b_base_teacher_qwen3_4b_base_rl \
        trainer.test_freq=1 \
