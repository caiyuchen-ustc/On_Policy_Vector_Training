...
##nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen3-4b-opd.sh >opd4b.log 2>&1 &
...
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen3_4b_non_thinking_teacher_qwen3_4b_non_thinking_rl_math_opd_deepmath' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=2 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/Qwen3-4B-Non-Thinking-Teacher-Qwen3-4B-Non-Thinking-RL-Math-OPD-DeepMath \
        trainer.test_freq=2 \
