...
# Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/dapo15-step"}

# Standard OPD 

# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen3-8b.sh >opd8b.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen3_8b_base_teacher_qwen3-8b_rl_dapo15' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=5 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/qwen3_8b_base_teacher_qwen3-8b_rl_dapo15 \
        trainer.test_freq=1 \
