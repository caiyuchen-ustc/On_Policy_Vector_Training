...
# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen3-8b_gopd.sh >opd8bgopd.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        +actor_rollout_ref.ref.model.base_model_path="$MODEL_PATH" \
        ...
        trainer.experiment_name='qwen3_8b_base_teacher_qwen3-8b_rl_gopd' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=4 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/qwen3_8b_base_teacher_qwen3-8b_rl_gopd \
        trainer.test_freq=2 \
