...
MODEL_PATH=${MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen3-8B-Base"}
Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/dapo27-step"}
# Standard OPD 

# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/g_opd/run_qwen3-8b_nobias.sh >opd8bnobias_gatetry.log 2>&1 &
python3 -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.actor.policy_loss.loss_mode="fused_future_adv" \
        ...
        trainer.experiment_name='qwen3_8b_base_teacher_qwen3-8b_rl_futureadv_gate_try' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=100 \
        trainer.default_local_dir=/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/qwen3_8b_base_teacher_qwen3-8b_rl_futureadv_gate_try \
        trainer.test_freq=1 \
