...
SCIKNOWEVAL_TRAIN_FILE=${SCIKNOWEVAL_TRAIN_FILE:-"${OPV_LEGACY_DATA_ROOT}/sciknoweval/sciknoweval_train.parquet"}
SCIKNOWEVAL_VAL_FILE=${SCIKNOWEVAL_VAL_FILE:-"${OPV_LEGACY_DATA_ROOT}/sciknoweval/sciknoweval_validation.parquet"}
...
Teacher_MODEL_PATH=${Teacher_MODEL_PATH:-"${OPV_LEGACY_MODEL_ROOT}/BroRL-1.5B"}
...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${OPV_ROOT}/repre"}
LOCAL_DIR_BASE=${LOCAL_DIR_BASE:-"${OPV_ROOT}"}
