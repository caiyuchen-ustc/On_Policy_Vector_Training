...
# TRAIN_FILE=${TRAIN_FILE:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/G-OPD-Training-Data/DeepMath-103K/train_filtered_level6.parquet"}
TRAIN_FILE=${TRAIN_FILE:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/DAPO/level6_prompt.parquet"}
...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/repre_qwen3-4b-rl"}
...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/repre/rl/trainable_vectors"}
