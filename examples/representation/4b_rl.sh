...
# TRAIN_FILE=${TRAIN_FILE:-"${OPV_LEGACY_DATA_ROOT}/G-OPD-Training-Data/DeepMath-103K/train_filtered_level6.parquet"}
TRAIN_FILE=${TRAIN_FILE:-"${OPV_LEGACY_DATA_ROOT}/DAPO/level6_prompt.parquet"}
...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"${OPV_ROOT}/examples/g_opd/repre_qwen3-4b-rl"}
...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${OPV_ROOT}/repre/rl/trainable_vectors"}
