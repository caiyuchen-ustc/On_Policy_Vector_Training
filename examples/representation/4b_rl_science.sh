...
# Experiment defaults
# -----------------------------
PROJECT_NAME=${PROJECT_NAME:-Science_DAPO}
EXP_NAME_PREFIX=${EXP_NAME_PREFIX:-DAPO-Qwen3-4B-RL}

NNODES=${NNODES:-1}
NGPUS_PER_NODE=${NGPUS_PER_NODE:-8}

MODEL_PATH=${MODEL_PATH:-"/apdcephfs_zwfy3/share_302867165/xxucaxu/models/raw/Qwen3-4B"}
TRAIN_FILE=${TRAIN_FILE:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/open_science_reasoning-2/open_science_reasoning_200k_level6_format.parquet"}
science_reasoning=${science_reasoning:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/open_science_reasoning-2/open_science_reasoning_eval.parquet"}
gpqa=${gpqa:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/data/gpqa/test.parquet"}
TEST_FILES="['${science_reasoning}', '${gpqa}']"
...
# Force numeric values even when users pass expressions like 1024*3.
...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/g_opd/repre_science_qwen3-4b-rl"}
...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/repre/science_rl/trainable_vectors"}
