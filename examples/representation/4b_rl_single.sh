...
# Single-vector RL wrapper around 4b_rl.sh.
...
export LOCAL_DIR_BASE="${LOCAL_DIR_BASE:-/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/rl/repre_qwen3-4b-singlev_lr${ACTOR_LR}}"

# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/representation/4b_rl_single.sh >4b_rl_single.log 2>&1 &
