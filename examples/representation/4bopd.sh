...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${OPV_ROOT}/repre/opd/repre_qwen3-4b-opd/trainable_vectors"}
...
LOCAL_DIR_BASE=${LOCAL_DIR_BASE:-"${OPV_ROOT}/examples/g_opd/repre_qwen3-4b-opd"}
...
DATA_ARGS=(
    data.train_files=${OPV_LEGACY_DATA_ROOT}/G-OPD-Training-Data/DeepMath-103K/train_filtered_level6.parquet
    ...
    data.iterative_test_files=${OPV_ROOT}/examples/eff_opd/hard_100.parquet
