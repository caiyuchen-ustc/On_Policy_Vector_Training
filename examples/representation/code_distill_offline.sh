...
EXP_NAME_PREFIX=${EXP_NAME_PREFIX:-Qwen3-4B-Code-OfflineDistill}
...
TEACHER_MODEL_PATH=${TEACHER_MODEL_PATH:-"${OPV_ROOT}/examples/code_rl/code_qwen3-4b-fullparam_lr1e-6_DAPO/global_step_300/hf_model"}
...
OFFLINE_TEACHER_DATA_PATH=${OFFLINE_TEACHER_DATA_PATH:-"${OPV_ROOT}/examples/code_offpolicy/teacher_sft/teacher_sft_all.parquet"}
...
LOCAL_DIR_BASE=${LOCAL_DIR_BASE:-"${OPV_ROOT}/examples/code_offline_distill"}
