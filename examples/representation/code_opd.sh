...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"${OPV_ROOT}/examples/code_opd/repre_qwen3-4b-code-opd"}
DEFAULT_LOCAL_DIR=${DEFAULT_LOCAL_DIR:-"${DEFAULT_LOCAL_DIR_BASE}/${TRAIN_TAG}_lr${ACTOR_LR}"}
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${OPV_ROOT}/repre/code_opd/trainable_vectors"}
