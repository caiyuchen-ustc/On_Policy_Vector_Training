...
export MODEL_PATH="${MODEL_PATH:-${OPV_LEGACY_MODEL_ROOT}/Qwen3-8B}"
...
export DEFAULT_LOCAL_DIR="${DEFAULT_LOCAL_DIR:-${OPV_ROOT}/examples/code_opd/code_qwen3-4b-singlev_layers${LAYER_TAG}_lr${ACTOR_LR}}"
export SAVE_VECTOR_DIR="${SAVE_VECTOR_DIR:-${OPV_ROOT}/repre/code_opd/trainable_vectors/singlev_layers${LAYER_TAG}_lr${ACTOR_LR}}"
...
# nohup sh ${OPV_ROOT}/examples/representation/code_opd_single.sh >code_opd_single_layers10-25.log 2>&1 &
