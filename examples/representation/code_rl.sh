...
MODEL_PATH=${MODEL_PATH:-"${OPV_LEGACY_MODEL_ROOT}/Qwen3-8B"}
...
# complete evaluation.
TRAIN_FILE=${TRAIN_FILE:-"${OPV_LEGACY_DATA_ROOT}/G-OPD-Training-Data/Eurus/code_train.parquet"}
CODE_VAL_FILE=${CODE_VAL_FILE:-"${OPV_LEGACY_DATA_ROOT}/G-OPD-Training-Data/Eurus/code_validation_100.parquet"}
LCB_VAL_FILE=${LCB_VAL_FILE:-"${OPV_LEGACY_DATA_ROOT}/G-OPD-Training-Data/Eurus/livecodebench_v5_100.parquet"}
...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"${OPV_ROOT}/examples/code_rl/repre_qwen3-4b-code-rl"}
...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${OPV_ROOT}/repre/code_rl/trainable_vectors"}
