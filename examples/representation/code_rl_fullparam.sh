...
export DEFAULT_LOCAL_DIR="${DEFAULT_LOCAL_DIR:-${OPV_ROOT}/examples/code_rl/code_qwen3-4b-fullparam_lr${ACTOR_LR}_DAPO}"
...
# nohup sh ${OPV_ROOT}/examples/representation/code_rl_fullparam.sh >code_rl_fullparam_1e-6.log 2>&1 &
