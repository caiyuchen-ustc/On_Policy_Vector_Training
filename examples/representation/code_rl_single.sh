...
export DEFAULT_LOCAL_DIR="${DEFAULT_LOCAL_DIR:-${OPV_ROOT}/examples/code_rl/code_qwen3-4b-singlev_layers${LAYER_TAG}_lr${ACTOR_LR}_DAPO}"
export SAVE_VECTOR_DIR="${SAVE_VECTOR_DIR:-${OPV_ROOT}/repre/code_rl/trainable_vectors/singlev_layers${LAYER_TAG}_lr${ACTOR_LR}}"
...
# nohup sh ${OPV_ROOT}/examples/representation/code_rl_single.sh >code_rl_single_layers0-20.log 2>&1 &
