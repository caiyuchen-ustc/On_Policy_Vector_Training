...
RUN_ROOT="${RUN_ROOT:-${OPV_ROOT}/deepseek1p5b_brorl_opd}"
...
# nohup sh ${OPV_ROOT}/examples/representation/deepseek1p5b_brorl_opd_fullparam.sh >1p5b_rl_fullparam1e-6.log 2>&1 &
