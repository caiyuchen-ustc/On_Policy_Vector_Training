...
# nohup bash examples/representation/gen_teacher_rollouts_deepseek1p5b.sh >gen_teacher_deepseek1p5b.log 2>&1 &
# ============================================================================
...
# Output.
export OUTPUT_BASE="${OUTPUT_BASE:-${OPV_ROOT}/examples/deepseek1p5b_offpolicy/teacher_sft}"
...
# nohup sh ${OPV_ROOT}/examples/representation/gen_teacher_rollouts_deepseek1p5b.sh >gen_teacher_rollouts_deepseek1p5b.log 2>&1 &
