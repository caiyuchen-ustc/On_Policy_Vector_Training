...
# Single-vector VerIF instruction-following OPD wrapper around verif_opd.sh.
...
# Vector-only OPD keeps the OPD-style higher LR and saves vector artifacts.
...
# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/representation/verif_opd_single.sh >verif_opd_0-20single.log 2>&1 &
