...
# Single-vector VerIF instruction-following RL wrapper around verif_rl.sh.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-VerIF-Qwen3-4B-IF-RL_singlev_layers${LAYER_TAG}_lr${ACTOR_LR}}"
export DEFAULT_LOCAL_DIR="${DEFAULT_LOCAL_DIR:-/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/examples/verif_rl/verif_qwen3-4b-singlev_layers${LAYER_TAG}_lr${ACTOR_LR}}"
export SAVE_VECTOR_DIR="${SAVE_VECTOR_DIR:-/apdcephfs_zwfy3/share_302867165/ewencai/CODE/GOPD/verl/repre/verif_rl/trainable_vectors/singlev_layers${LAYER_TAG}_lr${ACTOR_LR}}"

# nohup sh /apdcephfs_zwfy3/share_302867165/ewencai/CODE/G-OPD/verl/examples/representation/verif_rl_single.sh >verif_rl_single_layers0-20.log 2>&1 &
